...
infile = os.path.join(addr_BU_path,'trainval_36/trainval_resnet101_faster_rcnn_genome_36.tsv')
train_data_file = os.path.join(addr_hdf5path,'train36.hdf5')
val_data_file = os.path.join(addr_hdf5path,'val36.hdf5')
train_indices_file = os.path.join(addr_pkl_path,'train36_imgid2idx.pkl')
val_indices_file = os.path.join(addr_pkl_path,'val36_imgid2idx.pkl')
train_ids_file = os.path.join(addr_pkl_path,'train_ids.pkl')
val_ids_file = os.path.join(addr_pkl_path,'val_ids.pkl')
...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        train_imgids = utils.load_imageid(addr_train_imgs)
        val_imgids = utils.load_imageid(addr_val_imgs)
        pickle.dump(train_imgids, open(train_ids_file, 'wb'),protocol=2)
        pickle.dump(val_imgids, open(val_ids_file, 'wb'),protocol=2)
